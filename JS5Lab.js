 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting('Hayley','AR')
myGreeting.hello()
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
...
let yourBook = new Book('Foundation', 'Issac Asimov')
 ...
 * Step 2: Create a method inside of Movie called "describe" that returns 
 * the following sentence (make sure to fill in the title and director programmatically): 
 * "The movie [movie name here] was directed by [director name here]."
 * Step 3: Create another class called List with a constructor that is 
 * an empty array called movies
 * Step 4: Create a method called addMovie inside of List that will
 *  recieve a movie as a parameter and add it to the movies array
 * Step 5: Create another method called displayMovies in the List class that will return 
 * all of the movie titles and directors using a for loop
 * Step 6: Create two instances of Movie called movie1, 
 * use "Jurassic Park" and "Steven Spielberg" as it's arguments AND movie2, 
 * use "How the Grinch stole Christmas" and "Ron Howard" as it's arguments
...
let movie2 = new Movie('The Grinch that Stole Christmas', 'Ron Howard');
